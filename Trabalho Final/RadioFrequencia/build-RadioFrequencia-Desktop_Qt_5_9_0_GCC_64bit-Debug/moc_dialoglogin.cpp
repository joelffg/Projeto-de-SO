...
#include "../RadioFrequencia/dialoglogin.h"
...
QT_MOC_LITERAL(1, 12, 16), // "getTurmasDocente"
QT_MOC_LITERAL(2, 29, 15), // "map<int,string>"
...
QT_MOC_LITERAL(7, 71, 21) // "on_pushButton_clicked"
    ...
    "DialogLogin\0getTurmasDocente\0"
    "map<int,string>\0\0string\0username\0"
    "password\0on_pushButton_clicked"
};
...
static const uint qt_meta_data_DialogLogin[] = {
 ...
 // slots: name, argc, parameters, tag, flags
       1,    2,   24,    3, 0x08 /* Private */,
       7,    0,   29,    3, 0x08 /* Private */,
...
void DialogLogin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { map<int,string> _r = _t->getTurmasDocente((*reinterpret_cast< string(*)>(_a[1])),(*reinterpret_cast< string(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< map<int,string>*>(_a[0]) = std::move(_r); }  break;
...
const QMetaObject DialogLogin::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DialogLogin.data,
      qt_meta_data_DialogLogin,  qt_static_metacall, nullptr, nullptr}
};
